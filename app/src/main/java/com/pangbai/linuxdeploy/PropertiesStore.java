package com.pangbai.linuxdeploy;
...
class PropertiesStore extends ParamUtils {
    ...
    private static final String[] params = {"method", "method_options", "distrib", "arch", "suite", "source_path",
            "target_type", "target_path", "disk_size", "fs_type","host_name","user_name", "user_password",
